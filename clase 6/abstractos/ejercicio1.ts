...
class Cafe implements Bebida {
    preparar(): void {
        console.log('preparando Cafe: echandole agua caliente al cafe y colandolo ')
    }
}

class Te implements Bebida {
    preparar(): void {
        console.log('preparando Te: echandole agua caliente a un vaso con una bolsita de te ')
    }
}
